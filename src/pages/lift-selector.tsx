...
export default function LiftSelector({ onNavigate, onHome }: LiftSelectorProps) {
  ...
  const liftTypeTranslations: Record<string, Record<string, { name: string; description?: string }>> = {
    ...
    fr: {
      ...
      // Subtypes
      MOD_SEIL: { name: "Entraînement par Câble", description: "Modernisation ascenseur à câble" },
      MOD_BELT: { name: "Entraînement par Courroie", description: "Modernisation ascenseur à courroie" },
      MOD_HYD: { name: "Hydraulique", description: "Modernisation ascenseur hydraulique" },
      BEX_GEN2: { name: "Gen2", description: "Installation rénovation Gen2" },
      BEX_GEN360: { name: "Gen360", description: "Installation rénovation Gen360" },
      NEU_GEN2: { name: "Gen2", description: "Installation nouveau bâtiment Gen2" },
      NEU_GEN360: { name: "Gen360", description: "Installation nouveau bâtiment Gen360" },
    },
