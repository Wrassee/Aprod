...
export const translations: Record<string, Translation> = {
  hu: {
   ...
   italian: "Olasz",
    ...
    settingsSaveFailed: "Beállítások mentése sikertelen",
    settingsDescription: "A betöltési stratégia meghatározza, honnan töltődnek be a sablonok",
    liftType: "Lift típus",
    uploadFirstTemplate: 'Töltsd fel az első sablont a "Feltöltés" fülön!',
    selectQuestionTemplate: "Válassz kérdés sablont...",
    selectProtocolTemplate: "Válassz protokoll sablont...",
    selectedTemplates: "Kiválasztott sablonok:",
    quickStart: "Gyors Indítás ezzel a sablonnal",
    localLabel: "Helyi",
    templateCount: "sablon",
  ...
  de: {
   ...
   italian: "Italienisch",
    ...
    liftType: "Aufzugstyp",
    uploadFirstTemplate: 'Laden Sie die erste Vorlage im "Hochladen"-Tab hoch!',
    selectQuestionTemplate: "Fragenvorlage wählen...",
    selectProtocolTemplate: "Protokollvorlage wählen...",
    selectedTemplates: "Ausgewählte Vorlagen:",
    quickStart: "Schnellstart mit dieser Vorlage",
    localLabel: "Lokal",
  ...
  en: {
    ...
    localFirstDescription: "Uses local templates first if available (offline support)",
    cacheFirst: "Cache First",
    cacheFirstDescription: "Tries to load cached templates first",
    remoteOnly: "Remote Only",
    remoteOnlyDescription: "Uses only server-stored templates",
    settingsSaved: "Settings saved successfully",
    settingsSaveFailed: "Failed to save settings",
    settingsDescription: "The loading strategy determines where templates are loaded from",
    uploadFirstTemplate: 'Upload your first template in the "Upload" tab!',
    selectQuestionTemplate: "Select question template...",
    selectProtocolTemplate: "Select protocol template...",
    selectedTemplates: "Selected templates:",
    quickStart: "Quick Start with this template",
    localLabel: "Local",
  ...
  fr: {
    ...
    localFirstDescription: "Utilise d'abord les modèles locaux si disponibles (support hors ligne)",
    cacheFirst: "Cache en Premier",
    cacheFirstDescription: "Essaie de charger d'abord les modèles mis en cache",
    remoteOnly: "Distant Uniquement",
    remoteOnlyDescription: "Utilise uniquement les modèles stockés sur le serveur",
    settingsSaved: "Paramètres enregistrés avec succès",
    settingsSaveFailed: "Échec de l'enregistrement des paramètres",
    settingsDescription: "La stratégie de chargement détermine d'où sont chargés les modèles",
    uploadFirstTemplate: 'Téléchargez votre premier modèle dans l\'onglet "Téléchargement"!',
    selectQuestionTemplate: "Choisir un modèle de questions...",
    selectProtocolTemplate: "Choisir un modèle de protocole...",
    selectedTemplates: "Modèles sélectionnés:",
    quickStart: "Démarrage Rapide avec ce modèle",
    localLabel: "Local",
    templateCount: "modèles",
    unknownDate: "Date inconnue",
    remoteTemplates: "Modèles Distants",
  ...
  it: {
    ...
    localFirstDescription: "Utilizza prima i modelli locali se disponibili (supporto offline)",
    cacheFirst: "Cache Prima",
    cacheFirstDescription: "Prova a caricare prima i modelli memorizzati nella cache",
    remoteOnly: "Solo Remoto",
    remoteOnlyDescription: "Utilizza solo i modelli archiviati sul server",
    settingsSaved: "Impostazioni salvate con successo",
    settingsSaveFailed: "Salvataggio impostazioni fallito",
    settingsDescription: "La strategia di caricamento determina da dove vengono caricati i modelli",
    uploadFirstTemplate: 'Carica il primo modello nella scheda "Carica"!',
    selectQuestionTemplate: "Seleziona modello domande...",
    selectProtocolTemplate: "Seleziona modello protocollo...",
    selectedTemplates: "Modelli selezionati:",
    quickStart: "Avvio Rapido con questo modello",
    localLabel: "Locale",
    templateCount: "modelli",
    unknownDate: "Data sconosciuta",
    remoteTemplates: "Modelli Remoti",
