...
import { Progress } from '@/components/ui/progress'; // ÚJ: Hiányzó import!
  ...
  <div className="min-h-screen bg-light-surface">
    <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
      <div className="max-w-7xl mx-auto px-6 py-4">
        ...
        {/* ÚJ: Alsó sor - Progress sub-header (ahogy a questionnaire-ben) */}
        <div className="flex items-center justify-between">
          <div className="w-full">
            <div className="flex justify-between mb-1">
              <span className="text-base font-medium text-blue-700">
                {language === 'hu' ? 'Folyamat' : 'Fortschritt'}
              </span>
              <span className="text-sm font-medium text-blue-700">
                {globalCurrentStep} / {totalSteps} {language === 'hu' ? 'lépés' : 'Schritt'}
              </span>
            </div>
