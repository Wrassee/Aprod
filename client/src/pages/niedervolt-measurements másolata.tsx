...
  measurementTypes: { id: string; name: string; unit: string; }[];
...
  // ***JAVÍTVA***: A függőségi tömb üres [], így a hook csak egyszer fut le a komponens betöltődésekor.

  // Ez biztosítja, hogy a mentett adatok betöltése ne zavarodjon össze a szülő komponens állapotváltozásaival.
...
                    <strong>Mérési típusok:</strong> {measurementTypes.length} különböző elektromos mérés típus
