...
class ExcelParserService {
  ...
  async parseQuestionsFromExcel(filePath: string): Promise<ParsedQuestion[]> {
    try {
      ...
      // === KIBŐVÍTETT OSZLOPINDEX KERESÉS - MINDEN FORMÁTUMMAL ===
      const colIndices = {
        ...
        TITLE_HU: this.findHeaderIndex(headers, 'title_hu', 'titleHu', 'magyar_cím', 'Title HU', 'Title_HU', 'TitleHU'),
        TITLE_DE: this.findHeaderIndex(headers, 'title_de', 'titleDe', 'német_cím', 'Title DE', 'Title_DE', 'TitleDE'),
        TITLE_EN: this.findHeaderIndex(headers, 'title_en', 'titleEn', 'angol_cím', 'Title EN', 'Title_EN', 'TitleEN'),
        TITLE_FR: this.findHeaderIndex(headers, 'title_fr', 'titleFr', 'francia_cím', 'Title FR', 'Title_FR', 'TitleFR'),
        TITLE_IT: this.findHeaderIndex(headers, 'title_it', 'titleIt', 'olasz_cím', 'Title IT', 'Title_IT', 'TitleIT'),
        ...
        OPTIONS_DE: this.findHeaderIndex(headers, 'optionsDE', 'options_de', 'német_opciók', 'Options DE', 'Options_DE', 'OptionsDE'),
        OPTIONS_EN: this.findHeaderIndex(headers, 'optionsEN', 'options_en', 'angol_opciók', 'Options EN', 'Options_EN', 'OptionsEN'),
        OPTIONS_FR: this.findHeaderIndex(headers, 'optionsFR', 'options_fr', 'francia_opciók', 'Options FR', 'Options_FR', 'OptionsFR'),
        OPTIONS_IT: this.findHeaderIndex(headers, 'optionsIT', 'options_it', 'olasz_opciók', 'Options IT', 'Options_IT', 'OptionsIT'),
        ...
        PLACEHOLDER: this.findHeaderIndex(headers, 'placeholder', 'description', 'leírás', 'leiras', 'Placeholder', 'Placeholder HU'),
        PLACEHOLDER_DE: this.findHeaderIndex(headers, 'placeholderDE', 'placeholder_de', 'német_leírás', 'Placeholder DE', 'Placeholder_DE', 'PlaceholderDE'),
        PLACEHOLDER_EN: this.findHeaderIndex(headers, 'placeholderEN', 'placeholder_en', 'angol_leírás', 'Placeholder EN', 'Placeholder_EN', 'PlaceholderEN'),
        PLACEHOLDER_FR: this.findHeaderIndex(headers, 'placeholderFR', 'placeholder_fr', 'francia_leírás', 'Placeholder FR', 'Placeholder_FR', 'PlaceholderFR'),
        PLACEHOLDER_IT: this.findHeaderIndex(headers, 'placeholderIT', 'placeholder_it', 'olasz_leírás', 'Placeholder IT', 'Placeholder_IT', 'PlaceholderIT'),
        CELL_REF: this.findHeaderIndex(headers, 'cell_reference', 'cellReference', 'cella', 'cel', 'Cell Reference', 'CellReference'),
        SHEET_NAME: this.findHeaderIndex(headers, 'sheet_name', 'sheetName', 'munkalap', 'Sheet Name', 'SheetName'),
        MULTI_CELL: this.findHeaderIndex(headers, 'multi_cell', 'multiCell', 'több_cella', 'Multi Cell', 'MultiCell'),
        GROUP_NAME: this.findHeaderIndex(headers, 'group_name', 'groupName', 'csoport', 'Group Name', 'Group Name HU', 'GroupName'),
        GROUP_NAME_DE: this.findHeaderIndex(headers, 'group_name_de', 'groupNameDe', 'német_csoport', 'Group Name DE', 'Group_Name_DE', 'GroupNameDE'),
        GROUP_NAME_EN: this.findHeaderIndex(headers, 'group_name_en', 'groupNameEn', 'angol_csoport', 'Group Name EN', 'Group_Name_EN', 'GroupNameEN'),
        GROUP_NAME_FR: this.findHeaderIndex(headers, 'group_name_fr', 'groupNameFr', 'francia_csoport', 'Group Name FR', 'Group_Name_FR', 'GroupNameFR'),
        GROUP_NAME_IT: this.findHeaderIndex(headers, 'group_name_it', 'groupNameIt', 'olasz_csoport', 'Group Name IT', 'Group_Name_IT', 'GroupNameIT'),
        GROUP_KEY: this.findHeaderIndex(headers, 'groupKey', 'group_key', 'Group Key', 'GroupKey'),
        GROUP_ORDER: this.findHeaderIndex(headers, 'group_order', 'groupOrder', 'sorrend', 'Group Order', 'GroupOrder'),
